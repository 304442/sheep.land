    ...
    Alpine.data('udheyaBooking', () => ({
        ...
        scrollToSection: sel => {
            try {
                ...
                if (element) {
                    const headerOffset = (document.querySelector('.site-header')?.offsetHeight || 0) + (sel.startsWith('#step') || sel.startsWith('#udheya-booking-form-panel') ? (document.querySelector('.stepper-outer-wrapper')?.offsetHeight || 0) : 0);
