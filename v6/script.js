document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('udheyaBooking', () => ({
            ...
            try {
                ...
                if (settingsCollectionData && settingsCollectionData.items && settingsCollectionData.items.length > 0) {
                    ...
                    for (const key in fetchedSettings) {
                        if (fetchedSettings.hasOwnProperty(key) && key !== 'site_name') { // Retained site_name exclusion as it was in your base
        ...
        selectAnimal(cardEl, key) {
            ...
            // Auto-advance removed for Step 1. User will click "Continue to Customize".
        },
