...
const collectionsDefinition = [
    ...
    },
    {
        ...
        deleteRule: "@request.auth.id != '' && @request.auth.verified = true",
        fields: [
            { name: "name", type: "text", required: false, presentable: true, max: 150 },
            { name: "email", type: "email", required: false, presentable: true },
            { name: "phone", type: "text", required: false, presentable: true, max: 30 },
            ...
            { name: "isPublished", type: "bool", required: false, presentable: true },
            { name: "userAgent", type: "text", required: false, presentable: false, max: 500 },
